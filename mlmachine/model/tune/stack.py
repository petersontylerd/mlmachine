...
def modelParamBuilder(self, results, modelIx):
    ...
    Documentation:
        Description:
            Return dictionary of 'parameter : value' pairs to be passed as kwarg to model. 
            Used to efficiently reinstantiated specific models.
        Parameters:
            results : Pandas DataFrame
                DataFrame containing score summary generated by
                PowerGridSearcher
            modelIx : int
                Row index of specific model described in results DataFrame to be turned into 
...
def paramExtractor(self, resultsDf, estimator, iteration):
    ...
    Documentation:
        Description:
            Extract parameter dictionary from the input resultsDf DataFrame
        Parameters:
            ...
            iteration : int
                Number for identifying specific model parameters to capture from resultsDf.
        Returns:
            params : dictionary
